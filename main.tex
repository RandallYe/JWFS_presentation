...
\begin{frame}{Preferential choice $S \pref T$}
    \begin{itemize}
        ...
        \only<4->{\item Preference in wp \alert{\emph{is possible}} is adopting a three-valued G\"{o}del logic~\cite{GoedelLogic} (false, true, supertrue), mechanised in Isabelle/HOL (wpe semantics of GCL).
        \begin{itemize}
