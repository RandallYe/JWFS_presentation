...
%
    ...
    \only<3>{
        \begin{block}{PV semantics}
            Based on expression transformers~\cite{bGSL2023,Stoddart2024}: $\alert{S \diamond E}$ (prospective values of expression $E$ after the execution of $S$)\par
...
\begin{frame}{Conclusions}
    ...
    \begin{itemize}
        ...
        \item Extend ProbURel to support nondeterminism and concurrency, and develop practical tool to approximate probabilistic loops in addition to theorem proving
    \end{itemize}
    }
\end{frame}
