    ...
    \only<5>{
        \begin{block}{Kangfeng (Randall)}
            \begin{itemize}
                ...
                \item A research associate at York, working on formal verificaiton of security protocols  
            \end{itemize}
        \end{block}
    }
\end{frame}
...
\begin{frame}[c]{Motivations and Overview}
    ...
    \begin{columns}
        \begin{column}{0.60\textwidth}
            \vspace*{-2em}
            \begin{center}
                \includegraphics[scale=0.60]{pics/overall.pdf}
            \end{center}
        \end{column}
...
%    \only<2>{
        \begin{columns}
            ...
            \begin{column}{0.40\textwidth}
                ...
                \begin{itemize}
                    \item Kozen's seminal work\footnotemark[1]
                    \item He et al.'s "weakest completion" - probabilistic designs\footnotemark[2]
                    \item Hehner’s Probabilistic Predicative Programming (PPP)\footnotemark[3], and ProbURel
                    \item McIver and Morgan's expectation transformer semantics\footnotemark[4] 
                \end{itemize}
                }
                \only<2>{
                Probabilistic process algebras
                \begin{itemize}
                    \item Hansson’s alternating model; 
                    \item Segala and Lynch’s probabilistic automata;
                    \item Van Glabbeek et al.’s reactive, generative, and stratified models; 
                    \item probabilistic extensions based on CSP
                    \item PCSP$\#$
                \end{itemize}
                }
            \end{column}
        \end{columns}
        {\footnotetext[1]{Kozen, D.: Semantics of probabilistic programs. Journal of Computer and System
